...
Как набрать баллы?
 1. Ходить на секции (5 баллов за посещение, максимум 2 в неделю и 25 в семестр, если не потменить и не прийти - 0 баллов, на сессии словия другие). Надо набрать именно так как минимум 60 баллов, что бы получить зачёт. В сумме в итоге должно выйти 100 и более.
