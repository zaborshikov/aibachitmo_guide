...
- Последняя проверка информации: 03.09.2024
...
> Важно: информация по оценкам ТОЧНО не известна. Информация от студенческого офиса (СО), у которого мы относительно недавно уточняли ситуацию, противоречет информации от приёмной комиссии (ПК). Тут представлена информация которую представил СО. По данным ПК закрыть сесметр надо на 5 (также по допсы).
